...
import { Car, Coffee, Database,UserX, Package, SlidersHorizontal, CalendarDays, Shield, ShieldCheck, Timer,  CheckSquareIcon, LucideIcon, BookOpen, Users, BrainCircuit, FilterIcon, Network, TrendingUp, FlaskConical, Binary, Copy, Sigma, BarChart, Columns, Target, Component, HeartPulse, Feather, GitBranch, Smile, Scaling, AreaChart, LineChart, Layers, Map, Repeat, ScanSearch, Atom, MessagesSquare, Share2, GitCommit, DollarSign, ThumbsUp, ClipboardList, Handshake, Replace, Activity, Palette, Brain, Link2, FileSearch, TestTube, Briefcase, Factory, Landmark, Megaphone, FileUp, Settings, Check, FileDown, Bot, ListChecks, Upload, Play, Variable, BookOpen, ChevronsRight, Milestone, Settings2, BarChart3, Sparkles, HelpCircle, Info, Lightbulb, CheckCircle2, AlertTriangle, ChevronDown, FileCode, FileType, Wand2 } from "lucide-react";
...
export const exampleDatasets: ExampleDataSet[] = [
    ...
    },
    {
        ...
        description: 'Dataset for tracking product defects and sample sizes over time for attribute control charts.',
        icon: TrendingUp,
        analysisTypes: ['effectiveness-analysis'],
