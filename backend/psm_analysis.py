...
class AdvancedPSM:
    ...
    def visualize(self, X, prop_scores, treatment, matched_pairs):
        ...
        for i in range(X.shape[1]):
            treated = X.values[treatment == 1, i]
            control = X.values[treatment == 0, i]
            ...
            if matched_pairs:
                ...
                matched_treated = X.values[matched_treated_indices, i]
                matched_control = X.values[matched_control_indices, i]
