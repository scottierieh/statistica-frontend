...
class IndependentSamplesTTest:
    """Independent samples t-test analysis class."""
    ...
    def run_test(self, variable: str, group_variable: str, alternative: str = 'two-sided') -> dict:
        """
        ...
        group_variable : str
            Name of the categorical grouping variable (must have exactly 2 groups)
        alternative : str
        ...
        normality_test = {}
        for i, (group_name, group_data) in enumerate([(groups[0], group1_data), (groups[1], group2_data)]):
        ...
        t_stat_student, p_value_student = stats.ttest_ind(
            group1_data, group2_data, equal_var=True, alternative=alternative
        )
        df_student = n1 + n2 - 2
        ...
        t_stat_welch, p_value_welch = stats.ttest_ind(
            group1_data, group2_data, equal_var=False, alternative=alternative
        )
    ...
    def _generate_interpretation(self) -> str:
        ...
        g1, g2 = res['groups']
        m1, sd1 = res['descriptives'][g1]['mean'], res['descriptives'][g1]['std_dev']
        m2, sd2 = res['descriptives'][g2]['mean'], res['descriptives'][g2]['std_dev']
    ...
    def plot_results(self, figsize: tuple = (12, 10)) -> str:
        ...
        # Plot 1: Group distributions (histogram)
        sns.histplot(result['data1'], ax=axes[0, 0], color='#5B9BD5', 
                     label=str(result['groups'][0]), kde=True, alpha=0.6)
        sns.histplot(result['data2'], ax=axes[0, 0], color='#F4A582', 
                     label=str(result['groups'][1]), kde=True, alpha=0.6)
...
def main():
    ...
    try:
        ...
        # Run analysis
        tester = IndependentSamplesTTest(data)
