...
import { GripVertical, Plus, Trash2, ArrowLeft, CircleDot, CheckSquare, CaseSensitive, Star, PlusCircle, Eye, Shuffle, FileText, Save, Info, ImageIcon, X, Phone, Mail, Share2, ThumbsUp, Grid3x3, ChevronDown } from "lucide-react";
...
// All other question components here (Dropdown, Text, etc.)
    ...
    if (input) {
      input.onchange = (e) => {
        ...
        if (files && files[0]) {
          ...
          reader.onload = (event) => {
            handleUpdateQuestion({ id: questionId, imageUrl: event.target?.result as string } as Question);
          };
