...
import LtvPage from './pages/ltv-prediction-page';
...
import TurnoverAnalysisPage from './pages/turnover-rate-analysis-page';
import RiskMatrixPage from './pages/talent-risk-matrix-page';
import SatisfactionEngagementMatrixPage from './pages/satisfaction-engagement-matrix-page';
import AttendanceAnalysisPage from './pages/attendance-pattern-analysis-page';
import HeadcountStabilityPage from './pages/headcount-stability-analysis-page';
...
import InventoryOptimizationPage from './pages/inventory-policy-page';
