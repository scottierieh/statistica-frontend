     ...
     if (isPreview) {
        return (
            <div>
                ...
                <Input type="email" placeholder={question.text || "Enter email address..."} value={answer || ''} onChange={e => onAnswerChange?.(e.target.value)} />
            </div>
        );
    }
            ...
            <CardContent className="p-6 space-y-4">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <Input id={`placeholder-${question.id}`} placeholder="e.g., yourname@example.com" value={question.text || ''} onChange={(e) => onUpdate?.({...question, text: e.target.value})}/>
                </div>
            </CardContent>
        </Card>
    );
