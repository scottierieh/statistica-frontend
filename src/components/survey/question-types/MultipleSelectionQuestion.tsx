                    ...
                    {(question.options || []).map((option: string, index: number) => (
                       <Label 
                            ...
                            className={cn(
                                ...
                                answer?.includes(option) ? "shadow-md" : styles.transparentOptionBg ? 'bg-transparent hover:bg-primary/10' : 'bg-background hover:bg-primary/10'
                            )}
                            style={answer?.includes(option) ? { 
                        ...
                        >
                           <Checkbox
                               ...
                               indicatorStyle={{ backgroundColor: styles.primaryColor }}
                           />
