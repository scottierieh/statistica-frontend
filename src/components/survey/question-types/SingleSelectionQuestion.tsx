                    ...
                    {(question.options || []).map((option: string, index: number) => (
                         <Label 
                            ...
                            className={cn(
                                ...
                                answer === option ? "shadow-md" : styles.transparentOptionBg ? 'bg-transparent hover:bg-primary/10' : 'bg-background hover:bg-primary/10'
                            )}
                            style={answer === option ? { 
                        ...
                        >
                            <RadioGroupItem value={option} id={`q${question.id}-o${index}`} style={{ borderColor: styles.primaryColor, color: styles.primaryColor }} />
