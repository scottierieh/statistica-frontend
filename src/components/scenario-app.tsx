...
const analysisCategories = [
  {
    ...
    icon: BarChart,
    items: [
        { id: 'EffectivenessPage', label: 'Effectiveness Analysis', icon: Columns, component: EffectivenessPage },
        { id: 'ConcentrationPage', label: 'Concentration Analysis', icon: Columns, component: ConcentrationPage },
        { id: 'ScalabilityPage', label: 'Scalability Analysis', icon: Columns, component: ScalabilityPage },
