...
import { ChevronDown, Shield, TrendingDown, Zap, ShieldAlert, ArrowLeft, DollarSign, CandlestickChart } from 'lucide-react';
...
export default function DerivativesLayout() {
  ...
  const [openCategories, setOpenCategories] = useState<string[]>(['Risk Management', 'Pricing Models']);
