...
import { Sigma, Loader2, Target, Settings, Brain, BarChart as BarIcon, PieChart as PieIcon } from 'lucide-react';
...
export default function ConjointAnalysisPage({ data, allHeaders, onLoadExample }: ConjointAnalysisPageProps) {
    ...
    if (!canRun) return <Card><CardHeader><CardTitle>Conjoint Analysis</CardTitle></CardHeader><CardContent><p>Please upload data with at least two columns to perform conjoint analysis.</p></CardContent></Card>;
