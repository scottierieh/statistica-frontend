...
import { Loader2, Play, Scaling } from 'lucide-react';
...
export default function AdagradPage() {
    ...
    const handleSolve = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/analysis/adagrad', {
                method: 'POST',
            ...
            toast({ title: "Success", description: "Adagrad optimization complete." });
        } catch (e: any) {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>An optimizer that adapts the learning rate to the parameters, performing larger updates for infrequent and smaller updates for frequent parameters.</CardDescription>
            </CardHeader>
