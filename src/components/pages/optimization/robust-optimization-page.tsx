...
export default function RobustOptimizationPage() {
    return (
        <PlaceholderPage 
            title="Robust Optimization"
            description="This section is under construction. Tools for optimization against worst-case scenarios are coming soon!"
            icon={ShieldCheck}
        />
    );
}
