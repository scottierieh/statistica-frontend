...
import { ResponsiveContainer, LineChart, XAxis, YAxis, Tooltip, Legend, Line, CartesianGrid, Bar, BarChart, ReferenceLine, Cell } from 'recharts';
...
export default function GaborGrangerAnalysisPage({ survey, responses }: GaborGrangerPageProps) {
    ...
    if (!analysisResult) {
        return <Card><CardContent className="p-6 text-center text-muted-foreground"><p>No analysis results to display.</p></CardContent></Card>;
    }
