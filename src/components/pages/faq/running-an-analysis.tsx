    ...
    <FaqArticleLayout>
        <article className="prose prose-slate max-w-none">
            ...
            <section id="step-variables" className="scroll-mt-24 mb-16 border-t pt-12">
                <h2 id="step-variables" className="text-3xl font-bold mb-6 flex items-center gap-3">
            ...
            <section id="step-settings" className="scroll-mt-24 mb-16 border-t pt-12">
                <h2 id="step-settings" className="text-3xl font-bold mb-6 flex items-center gap-3">
            ...
            <section id="step-validation" className="scroll-mt-24 mb-16 border-t pt-12">
                <h2 id="step-validation" className="text-3xl font-bold mb-6 flex items-center gap-3">
