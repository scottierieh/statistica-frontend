  ...
  return (
    <FaqArticleLayout tocItems={SECTIONS}>
        ...
        <section id="what-is-user-types" className="scroll-mt-24 mb-16">
            ...
            <p>
                Our platform is designed to be versatile, catering to the unique needs of different professionals and learners. We've tailored our tools and workflows to support three primary user types, ensuring that everyone from a seasoned data scientist to a business executive can extract value from their data.
            </p>
            <p>
