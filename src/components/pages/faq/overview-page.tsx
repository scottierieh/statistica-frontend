...
const KEY_FEATURES = [
  {
    ...
    label: 'Method-Driven',
    description:
      'You choose the statistical method that fits your research question, not an algorithm',
  },
  {
    icon: ShieldCheck,
    label: 'Assumption-Aware',
    description:
      'Built-in validation checks ensure your data meets the requirements before running tests',
  },
  {
    icon: Lightbulb,
    label: 'Explainable Results',
    description:
      'Every result comes with plain-language explanations of what it means and why it matters',
  },
  {
    icon: FileText,
    label: 'Publication-Ready Output',
    description:
      'Get complete statistical tables, charts, and metrics formatted for academic or professional use',
  },
];
