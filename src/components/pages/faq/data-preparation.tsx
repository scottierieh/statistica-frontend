  ...
  return (
    <FaqArticleLayout tocItems={SECTIONS}>
        ...
        <section id="data-preview" className="scroll-mt-24 mb-16 border-t pt-12">
            ...
            <div className="space-y-6">
              <p className="text-base text-muted-foreground leading-relaxed">
                Once your data is loaded, you'll see a preview that shows the first few rows and all column names. This helps you verify that your data uploaded correctly.
              </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">The name of your uploaded file or selected example</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="p-2 bg-primary/10 rounded-lg flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-semibold mb-1">Data dimensions</h4>
                      <p className="text-sm text-muted-foreground">Number of rows (observations) and columns (variables)</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="p-2 bg-primary/10 rounded-lg flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">First 5-10 rows of your data to verify it looks correct</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3 p-4 rounded-lg border">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Export your current dataset as CSV</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 rounded-lg border">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Remove current data and start fresh</p>
                    </div>
                  </div>
                </div>
              </div>
