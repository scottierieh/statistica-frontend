...
export default function PcaLdaComparisonPage({ data, allHeaders, numericHeaders, categoricalHeaders, onLoadExample, onFileSelected }: { data?: DataSet, allHeaders?: string[], numericHeaders?: string[], categoricalHeaders?: string[], onLoadExample?: (example: ExampleDataSet) => void, onFileSelected?: (file: File) => void }) {
    ...
    return (
        <div className="space-y-4">
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline">PCA vs. LDA Comparison</CardTitle>
            ...
            {analysisResult && (
                <div className="grid md:grid-cols-2 gap-4">
                    <Card>
                        ...
                        <CardContent>
                             <Image src={analysisResult.plots.pca} alt="PCA Plot" width={800} height={600} className="rounded-md border" />
                        </CardContent>
                    </Card>
                     <Card>
                        <CardHeader>
                        ...
                        <CardContent>
                             <Image src={analysisResult.plots.lda} alt="LDA Plot" width={800} height={600} className="rounded-md border" />
                        </CardContent>
                    </Card>
                </div>
            )}
