            ...
            <Card>
                        ...
                        <TableBody>
                            {(results.anova_table || []).map((row: any, i: number) => (
                                <TableRow key={i}>
                                    ...
                                    <TableCell>{row.ddof1 ?? row.DF ?? 'N/A'}</TableCell>
             ...
             {results.mauchly_test && (
                 <Card>
                    ...
                    <CardContent>
                        <p>Sphericity assumed: {results.mauchly_test.spher ? 'Yes' : 'No'} (W={results.mauchly_test['W']?.toFixed?.(3) ?? 'N/A'}, p={results.mauchly_test['p-val']?.toFixed?.(4) ?? 'N/A'})</p>
