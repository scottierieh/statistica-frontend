...
import { ArrowLeft, Eye, Monitor, Tablet, Smartphone, Lightbulb, User, BarChart, ShieldCheck, BrainCircuit } from "lucide-react";
                ...
                <ScrollArea className="h-[calc(100vh-8rem)] pr-6">
                    <div className="space-y-6 py-4">
                        <div className="p-4 bg-blue-50 border-2 border-blue-200 rounded-lg shadow-sm">
                            <h4 className="font-semibold mb-2 text-blue-800 flex items-center gap-2"><User className="w-5 h-5"/> Add Demographics</h4>
                            <p className="text-sm text-blue-700">
                                Add <strong>demographic questions</strong> (e.g., age, gender, region) to enable powerful comparative analyses later, such as using crosstabs to see how different groups responded.
                            </p>
                        </div>
                         <div className="p-4 bg-green-50 border-2 border-green-200 rounded-lg shadow-sm">
                            <h4 className="font-semibold mb-2 text-green-800 flex items-center gap-2"><BarChart className="w-5 h-5"/> Use Scales, Not Just Yes/No</h4>
                            <p className="text-sm text-green-700">
                                Instead of a simple 'Yes/No', using a <strong>5 or 7-point Likert scale</strong> (e.g., 'Strongly Disagree' to 'Strongly Agree') captures more nuanced data. This enables a much wider range of statistical analyses, such as:
                            </p>
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                                <li>Keep it short and focused to maintain respondent engagement.</li>
                                <li>Start with broad, general questions before moving to specifics.</li>
                                <li>Use neutral language to avoid biasing responses.</li>
                                <li>Make essential questions required to ensure complete data.</li>
                            </ul>
                        </div>
                    </div>
                </ScrollArea>
