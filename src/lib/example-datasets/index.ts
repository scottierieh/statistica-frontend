...
export const exampleDatasets: ExampleDataSet[] = [
    {
        id: 'cancer-diagnosis',
        name: 'Cancer Diagnosis Data',
        description: 'Age, BMI, and smoking status to predict cancer presence. Ideal for Logistic Regression.',
        icon: HeartPulse,
        analysisTypes: ['logistic-regression', 'stats', 'glm'],
