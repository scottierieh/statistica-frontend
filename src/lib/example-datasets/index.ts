...
import { mcnemarData } from './mcnemar-data';
import { turfData } from './turf-data';
import { csatData } from './csat-data';
import { brandFunnelData } from './brand-funnel-data';
import { panelData } from './panel-data';
import { sarData } from './sar-data';
import { rddScholarshipData } from './rdd-data';
...
export const exampleDatasets: ExampleDataSet[] = [
    {
        ...
        description: 'Student GPA based on a test score cutoff for a scholarship program. Ideal for Regression Discontinuity.',
        icon: TrendingUp,
        analysisTypes: ['rdd', 'stats'],
        recommendedAnalysis: 'rdd',
        data: rddScholarshipData,
    },
    {
        id: 'dea-bank-data',
