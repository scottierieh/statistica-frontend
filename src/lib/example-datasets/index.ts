...
import { ahpData } from "./ahp-data";
import { didData } from "./did-data";
import { delphiData } from "./delphi-data";
import { marketingAnalysisData } from "./marketing-analysis-data";
import { gaborGrangerData } from "./gabor-granger-data";
import { maxdiffData } from './maxdiff-data';
import { vanWestendorpData } from "./van-westendorp-data";
...
export const exampleDatasets: ExampleDataSet[] = [
    {
        id: 'van-westendorp-data',
        name: 'Price Sensitivity Data',
        description: 'Customer responses to price perception questions.',
        icon: DollarSign,
        analysisTypes: ['van-westendorp'],
        recommendedAnalysis: 'van-westendorp',
        data: vanWestendorpData,
    },
    {
        id: 'maxdiff-data',
        name: 'Feature Preference (MaxDiff)',
        description: 'Respondent choices for the most and least important smartphone features.',
        icon: ThumbsUp,
        analysisTypes: ['maxdiff'],
        recommendedAnalysis: 'maxdiff',
        data: maxdiffData,
    },
     {
        ...
        icon: BarChart,
        analysisTypes: ['marketing-analysis'],
        recommendedAnalysis: 'marketing-analysis',
        data: marketingAnalysisData,
    },
    {
        id: 'gabor-granger',
        name: 'Pricing Study (Gabor-Granger)',
        description: 'Purchase intent at various price points. Ideal for Gabor-Granger analysis.',
        icon: DollarSign,
        analysisTypes: ['gabor-granger', 'stats'],
        recommendedAnalysis: 'gabor-granger',
