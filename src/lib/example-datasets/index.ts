...
export const exampleDatasets: ExampleDataSet[] = [
    {
        ...
        description: 'Dataset for analyzing the effectiveness of an intervention using pre-post and group comparisons.',
        icon: Target,
        analysisTypes: ['effectiveness'],
        recommendedAnalysis: 'effectiveness',
