...
export const exampleDatasets: ExampleDataSet[] = [
    ...
    },
    {
        ...
        icon: Users,
        analysisTypes: ['stats', 'one-way-anova', 'visuals', 'discriminant', 'kmeans', 'frequency',  'pca', 'normality', 'homogeneity', 'manova'],
    ...
    },
    {
        ...
        description: 'Text reviews for a restaurant. Good for text analysis.',
        icon: MessagesSquare,
        analysisTypes: ['wordcloud', 'sentiment', 'topic-modeling'],
    ...
    },
    {
        ...
        description: 'Efficiency analysis of bank branches using inputs and outputs.',
        icon: Scaling,
