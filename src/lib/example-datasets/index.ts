...
import { loanApprovalData } from './example-datasets/loan-approval-data';
...
export const exampleDatasets: ExampleDataSet[] = [
    ...
    },
    {
        ...
        icon: HeartPulse,
        analysisTypes: ['survival', 'stats', 'glm','crosstab', 'decision-tree'],
    ...
    },
    {
        id: 'loan-approval',
        name: 'Loan Approval',
        description: 'A dataset for predicting loan approval status based on applicant information.',
        icon: DollarSign,
        analysisTypes: ['decision-tree', 'logistic-regression', 'gbm', 'random-forest'],
        recommendedAnalysis: 'decision-tree',
