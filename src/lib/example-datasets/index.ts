...
export const exampleDatasets: ExampleDataSet[] = [
    ...
    },
    {
        ...
        icon: Columns,
        analysisTypes: ['crosstab', 'stats', 'frequency-analysis'],
    ...
    },  
    {
        ...
        description: 'Categorical data perfect for generating frequency counts and bar charts.',
        icon: Users,
        analysisTypes: ['frequency-analysis', 'stats'],
        recommendedAnalysis: 'frequency-analysis',
        data: crosstabData,
    },
    {
        id: 'rm-anova',
