...
import { comprehensiveMarketingData } from "./example-datasets/comprehensive-marketing-data";
...
export const exampleDatasets: ExampleDataSet[] = [
     {
        ...
        data: comprehensiveMarketingData,
    },
    {
        id: 'delphi-data',
