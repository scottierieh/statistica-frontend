...
export const exampleDatasets: ExampleDataSet[] = [
    {
        ...
        description: 'Simulated marketing data with revenue, source, and device info.',
        icon: BarChart,
        analysisTypes: ['marketing-analysis', 'stats'],
        recommendedAnalysis: 'marketing-analysis',
        data: marketingAnalysisData,
    },
    {
        id: 'delphi-data',
        name: 'Expert Opinion Survey',
        description: 'Simulated multi-round expert survey data for use with Delphi analysis.',
        icon: Users,
        analysisTypes: ['delphi', 'stats'],
        data: delphiData,
    },
    {
        id: 'dea-bank-data',
    ...
    {
        id: 'did-data',
        name: 'Policy Effect Study',
        description: 'Pre/post data for treatment and control groups. Ideal for DiD analysis.',
        icon: GitCommit,
        analysisTypes: ['did', 'stats'],
        data: didData,
    },
    {
        id: 'cbc-data',
