...
export const exampleDatasets: ExampleDataSet[] = [
    ...
    {
        id: 'spatial-autoregressive-data',
        name: 'Regional Crime Data',
        description: 'Crime rates and socioeconomic indicators for different regions.',
        icon: Map,
        analysisTypes: ['spatial-autoregressive-model'],
        recommendedAnalysis: 'spatial-autoregressive-model',
        data: sarData,
    },
    {
        id: 'ab-test-data',
