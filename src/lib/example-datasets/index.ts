...
export const exampleDatasets: ExampleDataSet[] = [
    {
    ...
    },
     {
        ...
        description: 'Performance scores of athletes over time, with a control and treatment group.',
        icon: Repeat,
        analysisTypes: ['rm-anova', 'stats'],
        recommendedAnalysis: 'rm-anova',
        data: rmAnovaData,
    },
    {
        id: 'time-series',
    ...
    },
    {
        ...
        icon: Users,
        analysisTypes: ['stats', 'correlation', 'one-way-anova', 'visuals', 'discriminant', 'kmeans', 'kmedoids', 'frequency', 'crosstab', 'pca', 'normality', 'homogeneity', 'manova', 'mds'],
