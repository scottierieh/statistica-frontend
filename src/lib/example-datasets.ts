...
export const exampleDatasets: ExampleDataSet[] = [
    ...
    {
        id: 'cross-tab',
        name: 'Product, Region, and Customer Satisfaction',
        description: 'Customer satisfaction levels by product and region.',
        icon: AreaChart,
        analysisTypes: ['cross-tab'],
        recommendedAnalysis: 'cross-tab',
        data: crosstabData,
    },  
    {
        id: 'meta-analysis',
