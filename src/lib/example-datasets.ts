...
export const exampleDatasets: ExampleDataSet[] = [
    ...
    },
    {
        id: 'meta-analysis',
        name: 'Meta-Analysis',
        description: 'Sample data for meta-analysis.',
        icon: Users,
    ...
    },
    {
        ...
        description: 'Response rises with dose and levels off near 100',
        icon: Users,
        analysisTypes: ['nonlinear-regression'],
        data: nonlinearRegressionData,
    },
    {
        id: 'crosstab',
        name: 'Product–Region Satisfaction',
        description: 'Satisfaction ratings for products A, B, and C across regions.',
        icon: Users,
...

    {
        ...
        description: 'Treatment vs. Control Improvement Over Time',
        icon: Users,
    ...
    },
    {
        ...
        icon: HeartPulse,
        analysisTypes: ['survival', 'stats', 'glm','cross-tab'],
    ...
    },
    {
        ...
        icon: TrendingUp,
        analysisTypes: ['stats', 'regression', 'correlation', 'glm', 'nonliear-regression'],
        data: regressionData,
    },
    {
        id: 'manova-groups',
