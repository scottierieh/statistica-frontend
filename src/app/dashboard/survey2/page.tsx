            ...
            <DialogContent className="max-w-3xl">
                ...
                <div className="py-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                         ...
                         <TemplateCard icon={Network} title="AHP: Criteria Weighting" description="Determine the relative importance of criteria without alternatives." href="/dashboard/survey/new/analysis?type=ahp"/>
