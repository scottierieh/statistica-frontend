...
export default function CreateSurveyPage() {
  ...
  const handleSelectQuestionType = (type: string) => {
    const newQuestion: Question = {
      ...
      scale: type === 'semantic-differential' ? ['Very Unlikely', 'Unlikely', 'Slightly Unlikely', 'Neutral', 'Slightly Likely', 'Likely', 'Very Likely'] : type === 'likert' ? ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree'] : type === 'matrix' ? ['Bad', 'Neutral', 'Good'] : type === 'rating' ? ['1','2','3','4','5'] : [],      numScalePoints: ['semantic-differential', 'likert'].includes(type) ? 7 : undefined,
