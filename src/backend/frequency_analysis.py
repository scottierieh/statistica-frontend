...
def main():
    try:
        ...
        for var in variables:
            ...
            sns.barplot(x='Frequency', y='Value', data=plot_data, ax=ax, color='#82ca9d', orient='h')
            
            ax.set_title(f'Frequency Distribution of {var}', fontsize=14, fontweight='bold', pad=20)
