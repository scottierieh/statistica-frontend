        ...
        def run_conjoint_analysis(sub_df, sub_attributes):
            ...
            for attr_name in independent_vars:
                ...
                if props['type'] == 'categorical':
                    ...
                    dummies = pd.get_dummies(sub_df_clean[attr_name], prefix=attr_name, drop_first=False).astype(int) # drop_first=False
            ...
            regression_results = {
                ...
                'adjustedRSquared': 1 - (1 - r2_score(y, y_pred)) * (len(y) - 1) / (len(y) - X.shape[1] - 1),
            ...
            for attr_name in independent_vars:
                props = sub_attributes[attr_name]
                if props['type'] == 'categorical':
                    level_names = original_levels_map[attr_name]
                    level_worths = []
                    ...
                    zero_centered_worths = level_worths - mean_worth
